...
const RecentlyUpdate = () => {
  ...
  return (
    <section className="container mx-auto my-10">
     <CustomTitle title={'Recently Update Reads'}/>
      <div className="pt-1 lg:pt-0 text-black dark:text-white mt-10 bg-[#F0F9FA] dark:bg-[#282F30] md:flex md:w-[100%] mx-auto rounded-lg lg:w-[52.5rem] xl:w-[100%]">
